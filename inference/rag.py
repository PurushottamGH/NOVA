...
class NovaRAG:
    ...
    def search(self, query: str, k: int = 3) -> list[str]:
        ...
        # Search index
        _distances, indices = self.index.search(query_vec, k)
    ...
    def load(self, path: str):
        ...
        with open(load_dir / "chunks.txt", encoding="utf-8") as f:
...
def rag_generate(
    model, tokenizer, rag: NovaRAG, query: str, k: int = 3, stream: bool = False, **gen_kwargs
):
    """
