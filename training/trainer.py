...
class Trainer:
    ...
    def __init__(self, model, config, train_loader, val_loader, tokenizer,
        ...
        if resume:
            ...
            print(f"  [Trainer] Manual clean start — starting from step {self.global_step}")
    ...
    @torch.no_grad()
    def generate_sample(self, prompt_text="The universe is", max_tokens=50, prefix=""):
        """Generate a single text sample and print it."""
        self.model.eval()
