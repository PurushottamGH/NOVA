...
class TransformerDecoderBlock(nn.Module):
    ...
    def forward(self, x: torch.Tensor, past_kv=None, use_cache=False):  # FIXED: added past_kv and use_cache to propagate KV cache
        """
        ...
        attn_output, present_kv = self.attention(normed_for_attn, past_kv=past_kv, use_cache=use_cache)  # (batch, seq_len, embed_dim)
