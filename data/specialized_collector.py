...
HEADERS = {
    "User-Agent": "NovaMind-Collector/1.0 (Contact: Purushottam)"
}
...
def download_blender_docs(output_dir):
    ...
    targets = [
        "bpy.ops.html", "bpy.data.html", "bpy.context.html", "bpy.types.html"
    ]
...
def download_github_repos(output_dir, topics=["pytorch", "blender-python", "data-science"]):
    """
